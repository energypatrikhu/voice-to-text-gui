...
export class SpeechRecognitionEngine {
	...
	async start(_outputPrefix: string | null) {
		...
		__app.console.debugLog(textReplacer(__app.translations.textFeedback.chromeFunctions.speechRecognition.start.outputPrefix, _outputPrefix));
	...
	private async speechRecognitionTranscript(transcript: string) {
		...
		__app.console.log(textReplacer(__app.translations.textFeedback.chromeFunctions.speechRecognition.transcript.partialOutput, this.partialOutput));
